    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div className="backdrop-blur-sm bg-white/70 rounded-3xl p-8 border border-emerald-200/50 shadow-xl">
            <h2 className="text-3xl font-bold text-emerald-900 mb-8">Send us a Message</h2>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-teal-700">ewttcars@gmail.com</p>
            ...
            {/* Emergency Contact */}
            <div className="backdrop-blur-sm bg-red-50/70 rounded-3xl p-8 border border-red-200/50 shadow-xl">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-xl font-bold text-red-800">+91 98672 85333</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-16">
          <h2 className="text-3xl font-bold text-emerald-900 mb-6">Ready to Book Your Ride?</h2>
